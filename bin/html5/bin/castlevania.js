...
ApplicationMain.preloader_onComplete = function(event) {
	...
	var hasMain = false;
	var _g = 0;
	var _g1 = Type.getClassFields(com.ukuleledog.games.castlevania.Main);
	while(_g < _g1.length) {
	...
	if(hasMain) Reflect.callMethod(com.ukuleledog.games.castlevania.Main,Reflect.field(com.ukuleledog.games.castlevania.Main,"main"),[]); else {
		var instance = Type.createInstance(DocumentClass,[]);
		if(js.Boot.__instanceof(instance,openfl.display.DisplayObject)) openfl.Lib.current.addChild(instance); else {
			haxe.Log.trace("Error: No entry point found",{ fileName : "ApplicationMain.hx", lineNumber : 224, className : "ApplicationMain", methodName : "preloader_onComplete"});
			haxe.Log.trace("If you are using DCE with a static main, you may need to @:keep the function",{ fileName : "ApplicationMain.hx", lineNumber : 225, className : "ApplicationMain", methodName : "preloader_onComplete"});
		}
	}
};
...
var com = {};
com.ukuleledog = {};
com.ukuleledog.games = {};
com.ukuleledog.games.castlevania = {};
com.ukuleledog.games.castlevania.Main = function() {
	openfl.display.Sprite.call(this);
	this.addEventListener(openfl.events.Event.ADDED_TO_STAGE,$bind(this,this.added));
};
$hxClasses["com.ukuleledog.games.castlevania.Main"] = com.ukuleledog.games.castlevania.Main;
com.ukuleledog.games.castlevania.Main.__name__ = ["com","ukuleledog","games","castlevania","Main"];
com.ukuleledog.games.castlevania.Main.main = function() {
	openfl.Lib.current.stage.align = openfl.display.StageAlign.TOP_LEFT;
	openfl.Lib.current.stage.scaleMode = openfl.display.StageScaleMode.NO_SCALE;
	openfl.Lib.current.addChild(new com.ukuleledog.games.castlevania.Main());
};
com.ukuleledog.games.castlevania.Main.__super__ = openfl.display.Sprite;
com.ukuleledog.games.castlevania.Main.prototype = $extend(openfl.display.Sprite.prototype,{
	resize: function(e) {
	...
	,init: function() {
		...
		this.inited = true;
		this.addChild(new com.ukuleledog.games.castlevania.state.GameState());
	}
	,added: function(e) {
	...
	,__class__: com.ukuleledog.games.castlevania.Main
});
var DocumentClass = function() {
	this.stage = openfl.Lib.current.stage;
	com.ukuleledog.games.castlevania.Main.call(this);
	this.dispatchEvent(new openfl.events.Event(openfl.events.Event.ADDED_TO_STAGE,false,false));
};
$hxClasses["DocumentClass"] = DocumentClass;
DocumentClass.__name__ = ["DocumentClass"];
DocumentClass.__super__ = com.ukuleledog.games.castlevania.Main;
DocumentClass.prototype = $extend(com.ukuleledog.games.castlevania.Main.prototype,{
...
com.ukuleledog.games.core = {};
com.ukuleledog.games.core.GameObject = function() {
	openfl.display.Bitmap.call(this);
};
$hxClasses["com.ukuleledog.games.core.GameObject"] = com.ukuleledog.games.core.GameObject;
com.ukuleledog.games.core.GameObject.__name__ = ["com","ukuleledog","games","core","GameObject"];
com.ukuleledog.games.core.GameObject.__super__ = openfl.display.Bitmap;
com.ukuleledog.games.core.GameObject.prototype = $extend(openfl.display.Bitmap.prototype,{
	__class__: com.ukuleledog.games.core.GameObject
});
com.ukuleledog.games.core.AnimatedObject = function() {
	this.currentAnimationLoop = true;
	this.currentAnimationSpeed = 0;
	this.currentAnimationWidth = 0;
	this.currentAnimationHeight = 0;
	this.currentAnimationLength = 0;
	this.currentAnimationY = 0;
	this.currentAnimationX = 0;
	this.currentFrame = 0;
	com.ukuleledog.games.core.GameObject.call(this);
	this.animationHeights = new haxe.ds.StringMap();
	this.animationLengths = new haxe.ds.StringMap();
	this.animationPositionsX = new haxe.ds.StringMap();
	this.animationPositionsY = new haxe.ds.StringMap();
	this.animationWidths = new haxe.ds.StringMap();
	this.animationSpeeds = new haxe.ds.StringMap();
	this.animationLooping = new haxe.ds.StringMap();
	this.addEventListener(openfl.events.Event.REMOVED_FROM_STAGE,$bind(this,this.kill));
};
$hxClasses["com.ukuleledog.games.core.AnimatedObject"] = com.ukuleledog.games.core.AnimatedObject;
com.ukuleledog.games.core.AnimatedObject.__name__ = ["com","ukuleledog","games","core","AnimatedObject"];
com.ukuleledog.games.core.AnimatedObject.__super__ = com.ukuleledog.games.core.GameObject;
com.ukuleledog.games.core.AnimatedObject.prototype = $extend(com.ukuleledog.games.core.GameObject.prototype,{
	setAnimation: function(name) {
		if(name == this.currentAnimation) return;
		if(this.animationTimer != null) {
			this.animationTimer.removeEventListener("timer",$bind(this,this.animationLoop));
			this.animationTimer = null;
		}
		this.currentAnimation = name;
		this.currentFrame = 0;
		this.currentAnimationX = this.animationPositionsX.get(name);
		this.currentAnimationY = this.animationPositionsY.get(name);
		this.currentAnimationLength = this.animationLengths.get(name);
		this.currentAnimationHeight = this.animationHeights.get(name);
		this.currentAnimationWidth = this.animationWidths.get(name);
		this.currentAnimationSpeed = this.animationSpeeds.get(name);
		this.currentAnimationLoop = this.animationLooping.get(name);
		if((function($this) {
			var $r;
			var a = $this.currentAnimationLength;
			var aNeg = a < 0;
			var bNeg = 1 < 0;
			$r = aNeg != bNeg?aNeg:a > 1;
			return $r;
		}(this))) {
			this.animationTimer = new openfl.utils.Timer(this.currentAnimationSpeed);
			this.animationTimer.addEventListener("timer",$bind(this,this.animationLoop));
			this.animationTimer.start();
		}
		this.animationLoop();
	}
	,createAnimation: function(name,startX,startY,length,height,width,speed,looping) {
		...
		this.animationSpeeds.set(name,speed * 1000);
		this.animationLooping.set(name,looping);
	}
	,animate: function(name) {
		if(name == null) name = "idle";
		this.setAnimation(name);
	}
	,animationLoop: function(e) {
		var tempBmd = new openfl.display.BitmapData(this.currentAnimationWidth,this.currentAnimationHeight,true);
		tempBmd.copyPixels(this.bmd,new openfl.geom.Rectangle((function($this) {
			var $r;
			var $int = $this.currentAnimationX + $this.currentFrame * $this.currentAnimationWidth;
			$r = $int < 0?4294967296.0 + $int:$int + 0.0;
			return $r;
		}(this)),(function($this) {
			var $r;
			var int1 = $this.currentAnimationY;
			$r = int1 < 0?4294967296.0 + int1:int1 + 0.0;
			return $r;
		}(this)),(function($this) {
			var $r;
			var int2 = $this.currentAnimationWidth;
			$r = int2 < 0?4294967296.0 + int2:int2 + 0.0;
			return $r;
		}(this)),(function($this) {
			var $r;
			var int3 = $this.currentAnimationHeight;
			$r = int3 < 0?4294967296.0 + int3:int3 + 0.0;
			return $r;
		}(this))),new openfl.geom.Point(0,0));
		this.bitmapData = tempBmd;
		if((function($this) {
			var $r;
			var a = $this.currentFrame + 1;
			var b = $this.currentAnimationLength;
			$r = (function($this) {
				var $r;
				var aNeg = b < 0;
				var bNeg = a < 0;
			...
			return $r;
		}(this))) this.currentFrame++; else if(this.currentAnimationLoop) this.currentFrame = 0; else this.animationTimer.removeEventListener("timer",$bind(this,this.animationLoop));
	}
	,kill: function(e) {
		this.removeEventListener(openfl.events.Event.REMOVED_FROM_STAGE,$bind(this,this.kill));
		if((function($this) {
			var $r;
			var a = $this.currentAnimationLength;
			var aNeg = a < 0;
			...
			$r = aNeg != bNeg?aNeg:a >= 1;
			return $r;
		}(this)) && this.animationTimer != null) {
			this.animationTimer.removeEventListener("timer",$bind(this,this.animationLoop));
			this.animationTimer.stop();
			this.animationTimer = null;
		}
	}
	,__class__: com.ukuleledog.games.core.AnimatedObject
});
com.ukuleledog.games.castlevania.elements = {};
com.ukuleledog.games.castlevania.elements.Alucard = function() {
	this.playable = false;
	var _g = this;
	com.ukuleledog.games.core.AnimatedObject.call(this);
	this.bmd = openfl.Assets.getBitmapData("img/spritesheet.png");
	this.createAnimation("idle",0,0,6,50,50,0.15);
	this.createAnimation("walk",0,50,16,50,50,0.05);
	this.createAnimation("crouch",0,100,11,50,50,0.05,false);
	this.createAnimation("fall",0,150,6,50,50,0.1,false);
	this.createAnimation("hurt1",0,200,1,50,50,0.5,false);
	this.createAnimation("hurt2",50,200,1,50,50,0.5,false);
	this.createAnimation("hurt3",100,200,1,50,50,0.5,false);
	this.createAnimation("hurt4",150,200,1,50,50,0.5,false);
	this.createAnimation("hit1",150,250,3,50,50,0.05,false);
	this.createAnimation("hit2",0,250,2,50,60,0.05,false);
	this.animate("fall");
...
$hxClasses["com.ukuleledog.games.castlevania.elements.Alucard"] = com.ukuleledog.games.castlevania.elements.Alucard;
com.ukuleledog.games.castlevania.elements.Alucard.__name__ = ["com","ukuleledog","games","castlevania","elements","Alucard"];
com.ukuleledog.games.castlevania.elements.Alucard.__super__ = com.ukuleledog.games.core.AnimatedObject;
com.ukuleledog.games.castlevania.elements.Alucard.prototype = $extend(com.ukuleledog.games.core.AnimatedObject.prototype,{
	__class__: com.ukuleledog.games.castlevania.elements.Alucard
});
com.ukuleledog.games.core.State = function() {
	openfl.display.Sprite.call(this);
};
$hxClasses["com.ukuleledog.games.core.State"] = com.ukuleledog.games.core.State;
com.ukuleledog.games.core.State.__name__ = ["com","ukuleledog","games","core","State"];
com.ukuleledog.games.core.State.__super__ = openfl.display.Sprite;
com.ukuleledog.games.core.State.prototype = $extend(openfl.display.Sprite.prototype,{
	__class__: com.ukuleledog.games.core.State
});
com.ukuleledog.games.castlevania.state = {};
com.ukuleledog.games.castlevania.state.GameState = function() {
	com.ukuleledog.games.core.State.call(this);
	this.addEventListener(openfl.events.Event.ADDED_TO_STAGE,$bind(this,this.init));
};
$hxClasses["com.ukuleledog.games.castlevania.state.GameState"] = com.ukuleledog.games.castlevania.state.GameState;
com.ukuleledog.games.castlevania.state.GameState.__name__ = ["com","ukuleledog","games","castlevania","state","GameState"];
com.ukuleledog.games.castlevania.state.GameState.__super__ = com.ukuleledog.games.core.State;
com.ukuleledog.games.castlevania.state.GameState.prototype = $extend(com.ukuleledog.games.core.State.prototype,{
	init: function(e) {
		this.removeEventListener(openfl.events.Event.ADDED_TO_STAGE,$bind(this,this.init));
		var imageData = openfl.Assets.getBitmapData("img/backdrop.png");
		var bgData = new openfl.display.BitmapData(255,207,false);
		bgData.copyPixels(imageData,new openfl.geom.Rectangle(0,0,255,207),new openfl.geom.Point(0,0));
		var fgData = new openfl.display.BitmapData(255,207,true);
		fgData.copyPixels(imageData,new openfl.geom.Rectangle(255,0,255,207),new openfl.geom.Point(0,0));
		var fgsData = new openfl.display.BitmapData(255,207,true);
		fgsData.copyPixels(imageData,new openfl.geom.Rectangle(510,0,255,207),new openfl.geom.Point(0,0));
		this.background = new openfl.display.Bitmap(bgData);
		this.background.set_width(this.stage.stageWidth);
		this.background.set_scaleY(this.background.get_scaleX());
		this.addChild(this.background);
		this.alucard = new com.ukuleledog.games.castlevania.elements.Alucard();
		this.alucard.set_y(220);
		this.alucard.set_x(120);
		this.addChild(this.alucard);
		this.foregroundShadow = new openfl.display.Bitmap(fgsData);
		this.foregroundShadow.set_width(this.stage.stageWidth);
		this.foregroundShadow.set_scaleY(this.foregroundShadow.get_scaleX());
		this.foregroundShadow.set_alpha(0.5);
		this.addChild(this.foregroundShadow);
		this.foreground = new openfl.display.Bitmap(fgData);
		this.foreground.set_width(this.stage.stageWidth);
		this.foreground.set_scaleY(this.foreground.get_scaleX());
		this.addChild(this.foreground);
		this.stage.addEventListener(openfl.events.KeyboardEvent.KEY_DOWN,$bind(this,this.keyDownHandle));
		this.stage.addEventListener(openfl.events.KeyboardEvent.KEY_UP,$bind(this,this.keyUpHandle));
		this.addEventListener(openfl.events.Event.ENTER_FRAME,$bind(this,this.gameloop));
	}
	,keyDownHandle: function(e) {
		if(this.keysPressed == null) this.keysPressed = new Array();
	...
	,gameloop: function(e) {
		var _g = this;
		if(this.keysPressed[40] == true && this.alucard.playable == true) this.alucard.setAnimation("crouch"); else if(this.keysPressed[90] == true && this.alucard.playable == true) {
			this.alucard.setAnimation("hit1");
			haxe.Timer.delay(function() {
				_g.keysPressed[90] = false;
				_g.alucard.setAnimation("idle");
			},150);
		} else if(this.keysPressed[65] == true && this.alucard.playable == true) {
			this.alucard.setAnimation("hit2");
			haxe.Timer.delay(function() {
				_g.keysPressed[65] = false;
				_g.alucard.setAnimation("idle");
			},100);
		} else this.alucard.setAnimation("idle");
	}
	,__class__: com.ukuleledog.games.castlevania.state.GameState
});
var haxe = {};
...
openfl.display.DrawCommand.DrawTiles = function(sheet,tileData,smooth,flags) { var $x = ["DrawTiles",6,sheet,tileData,smooth,flags]; $x.__enum__ = openfl.display.DrawCommand; return $x; };
