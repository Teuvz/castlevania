...
class ApplicationMain {
	...
	public static function main () {
		...
		//nme.Lib.setPackage("Matt", "castlevania", "com.ukuleledog.games.castlevania.castlevania", "1.0.0");
	...
	private static function start ():Void {
		...
		var hasMain = false;
		var mainClass = Type.resolveClass ("com.ukuleledog.games.castlevania.Main");
...
import com.ukuleledog.games.castlevania.Main;
...
class ApplicationMain {
	...
	public static function main () {
		...
		for (methodName in Type.getClassFields (com.ukuleledog.games.castlevania.Main)) {
		...
		if (hasMain) {
			...
			Reflect.callMethod (com.ukuleledog.games.castlevania.Main, Reflect.field (com.ukuleledog.games.castlevania.Main, "main"), []);
...
@:keep class DocumentClass extends com.ukuleledog.games.castlevania.Main { }
